                    ...
                    <ScrollView style={{flexDirection: 'column'}}>
                        <View style={{marginLeft: 1, flexDirection: 'row', justifyContent: 'space-around'}}>
                            <TouchableOpacity
                                ...
                                <Image style={styles.inputIcon}
                                       source={this.state.egg == 0 ? Arrayimages.img1 : Arrayimages2.img11}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked1(1)} active={this.state.gluten == 1}>
                                <Image style={styles.inputIcon}
                                       source={this.state.gluten == 1 ? Arrayimages.img2 : Arrayimages2.img22}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked2(2)} active={this.state.peanut == 2}>
                                <Image style={styles.inputIcon}
                                       source={this.state.peanut == 2 ? Arrayimages.img3 : Arrayimages2.img33}/>
                            </TouchableOpacity>
                        </View>
                        <View style={{marginLeft: 10, flexDirection: 'row', justifyContent: 'space-around'}}>
                            <TouchableOpacity
                                ...
                                <Image style={styles.inputIcon}
                                       source={this.state.seafood == 3 ? Arrayimages.img4 : Arrayimages2.img44}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked4(4)} active={this.state.sesame == 4}>
                                <Image style={styles.inputIcon}
                                       source={this.state.sesame == 4 ? Arrayimages.img5 : Arrayimages2.img55}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked5(5)} active={this.soy == 5}>
                                <Image style={styles.inputIcon}
                                       source={this.state.soy == 5 ? Arrayimages.img6 : Arrayimages2.img66}/>
                            </TouchableOpacity>
                        </View>
                        <View style={{marginLeft: 10, flexDirection: 'row', justifyContent: 'space-around'}}>
                            <TouchableOpacity
                                ...
                                <Image style={styles.inputIcon}
                                       source={this.state.sulfite == 6 ? Arrayimages.img7 : Arrayimages2.img77}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked7(7)} active={this.state.treenut == 7}>
                                <Image style={styles.inputIcon}
                                       source={this.state.treenut == 7 ? Arrayimages.img8 : Arrayimages2.img88}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked8(8)} active={this.state.wheat == 8}>
                                <Image style={styles.inputIcon}
                                       source={this.state.wheat == 8 ? Arrayimages.img9 : Arrayimages2.img99}/>
                            </TouchableOpacity>
                        </View>
                        <View style={{marginLeft: 10, flexDirection: 'row', justifyContent: 'space-around'}}>
                            <TouchableOpacity
                                ...
                                <Image style={styles.inputIcon}
                                       source={this.state.dairy == 9 ? Arrayimages.img0 : Arrayimages2.img00}/>
                            </TouchableOpacity>
                        </View>
