                    ...
                    <ScrollView style={{flexDirection: 'column', marginTop: 30}}>
                        <View style={{marginLeft: 1, flexDirection: 'row', justifyContent: 'space-around'}}>
                            <TouchableOpacity
                                ...
                                <Image style={styles.inputIcon}
                                       source={this.state.avocado == 0 ? Arrayimages.img1 : Arrayimages2.img11}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked1(1)} active={this.state.beef == 1}>
                                <Image style={styles.inputIcon}
                                       source={this.state.beef == 1 ? Arrayimages.img2 : Arrayimages2.img22}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked2(2)} active={this.state.eggplant == 2}>
                                <Image style={styles.inputIcon}
                                       source={this.state.eggplant == 2 ? Arrayimages.img3 : Arrayimages2.img33}/>
                            </TouchableOpacity>
                        </View>
                        <View style={{marginLeft: 10, flexDirection: 'row', justifyContent: 'space-around'}}>
                            <TouchableOpacity
                                ...
                                <Image style={styles.inputIcon}
                                       source={this.state.mushrooms == 3 ? Arrayimages.img4 : Arrayimages2.img44}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked4(4)} active={this.state.pork == 4}>
                                <Image style={styles.inputIcon}
                                       source={this.state.pork == 4 ? Arrayimages.img5 : Arrayimages2.img55}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked5(5)} active={this.onions == 5}>
                                <Image style={styles.inputIcon}
                                       source={this.state.onions == 5 ? Arrayimages.img6 : Arrayimages2.img66}/>
                            </TouchableOpacity>
                        </View>
                        <View style={{marginLeft: 10, flexDirection: 'row', justifyContent: 'space-around'}}>
                            <TouchableOpacity
                                ...
                                <Image style={styles.inputIcon}
                                       source={this.state.suger == 6 ? Arrayimages.img7 : Arrayimages2.img77}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked7(7)} active={this.state.olives == 7}>
                                <Image style={styles.inputIcon}
                                       source={this.state.olives == 7 ? Arrayimages.img8 : Arrayimages2.img88}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={{marginLeft: 40}}
                                              onPress={() => this.segrantClicked8(8)} active={this.state.alcohole == 8}>
                                <Image style={styles.inputIcon}
                                       source={this.state.alcohole == 8 ? Arrayimages.img0 : Arrayimages2.img00}/>
                            </TouchableOpacity>
                        </View>
